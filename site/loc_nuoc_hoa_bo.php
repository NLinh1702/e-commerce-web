    ...
    <body>
        ...
        $n=0; while ($r= $rs_sanpham->fetch_assoc()) { if($r['idSP'] == 1) continue;
            ...
            echo $r['TenSP'];echo"</span>
                        ...
                        <a style=\"color: #0e86c1;\" href=\"MoTa.php?idSP="; echo $r['idSP']; echo" onclick=\"BuyNow(1379)\" class=\"btn btn-default buyproduct\"><strong>Xem chi tiết</strong></a>
                    </div>
                </div>
            </div>
";}
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6" style="margin-bottom:10px">
                        ...
                        <div class="item">
                            ...
                            <span class="prod-block">
                                ...
                                <a href="GioHang.php?idSP=<?php echo $r['idSP'];?>" class="addcartbtn" onclick="AddCart"></a>

                                <a href="MoTa.php?idSP=<?php echo $r['idSP'];?>" onclick="BuyNow(1379)" class="btn btn-default buyproduct"><strong>Xem chi tiết</strong></a>
                            </div>
                        </div>
                    </div>
