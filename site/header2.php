...
<div class=\"container\">
    <div class=\"row navbar\">
        ...
        <div class=\"col-md-6\" style=\"margin-top: -9px; margin-left: 18px;\">
                ...
                <ul class=\"srt-menu\" id=\"menu-main-navigation\" >
                    <li class=\"current\">";
                            ...
                            if(isset($_SESSION['HoTenK']))
                            {
                                ...
                                echo "
                                        <li>
                                        <a href=\"#\" style=\"background-color: gray;\"><i class=\"fa-solid fa-user\"></i> ";echo "<strong>". $nameuser."</strong>"; echo "</a>
                                            <ul>
            ...
            
                            {
                                    echo "
                                            <li>
                                                <a href=\"#\" style=\"background-color: gray;\"><i class=\"fa-solid fa-user\"></i> Tài khoản</a>
                                                <ul>
