...
?>
<div class="row col-md-offset-4"><h2>Sản phẩm nổi bật</h2></div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-6" style="margin-bottom:10px">
                ...
                <div class="item">
                    ...
                    <div class="prod-box">
                        ...
                        <a style="color: #0e86c1;" href="MoTa.php?idSP=<?php echo $r['idSP'];?>" onclick="BuyNow(1379)" class="btn btn-default buyproduct"><strong>Thêm vào giỏ</strong></a>
                    </div>
                </div>
            </div>
